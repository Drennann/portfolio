...
export default function Proyects({dataaos}){
    ...
    return(
        <div className="Proyects" id="#PROYECTSID">
            ...
            <Proyect end="end" proyectoDescription = "A simplified chess game. react, javascript, html and css were used" proyectoImg={"leaguemerch.png"} proyectoUrlDeploy="https://leaguemerch.up.railway.app/" proyectoUrlGithub="https://github.com/Drennann/ecommerceleague"/>
            ...
            <Proyect proyectoDescription = "Online to-do list application, connected to a database and with a backend included" proyectoImg={"todo.png"} proyectoUrlDeploy="https://mern-stack-2-delpan.herokuapp.com/" proyectoUrlGithub="https://dashboard.heroku.com/apps/mern-stack-2-delpan"/>
